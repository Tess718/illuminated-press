...
const TrendingTopics = () => {
  ...
  return (
    <div className="bg-[linear-gradient(113.94deg,rgba(26,219,187,0.08)_-25.88%,rgba(20,165,237,0.08)_6.86%,rgba(127,100,251,0.08)_36.47%,rgba(243,50,101,0.08)_66.87%,rgba(255,175,132,0.08)_95.7%,rgba(255,118,108,0.08)_123.75%)] p-6 rounded-xl text-white w-full h-full">
